...
$file = '../quotes.txt';
$value = 'Enter your quotation here.';
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') { // Handle the form.
	...
	if ( !empty($_POST['quote']) && ($_POST['quote'] != 'Enter your quotation here.') ) { // Need some thing to write.
		...
		if (is_writable($file) && file_exists($file)) { // Confirm that the file is writable.
...
<textarea name="quote" rows="5" cols="30"><?php echo $value ?></textarea><br />
